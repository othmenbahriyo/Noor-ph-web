...
import Hero from '@/components/AudioCoran/Hero';
import Intro from '@/components/AudioCoran/Intro';
import Features from '@/components/AudioCoran/Features';
import Screenshots from '@/components/AudioCoran/Screenshots';
...
export default async function AudioCoranPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
