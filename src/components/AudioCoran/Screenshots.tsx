...
const SCREENSHOT_FILES = [
  'screenshot-audio-player.webp',
  'screenshot-audio-verses.webp',
  'screenshot-audio-surahs.webp',
  'screenshot-audio-reciter.webp',
];

export default async function Screenshots() {
  const t = await getTranslations('audioCoran.screenshots');
